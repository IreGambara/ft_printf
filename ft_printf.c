...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/02/13 19:03:57 by igambara          #+#    #+#             */
/*   Updated: 2021/02/13 19:04:02 by igambara         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	flags->point = 1;
	if (str[0][1] > 47 && str[0][1] < 58)
	{
		(*str)++;
		flags->precision = precisiion(str);
	}
	else if (str[0][1] == '*')
	{
